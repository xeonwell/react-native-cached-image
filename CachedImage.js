...
function getImageProps(props) {
  return omit(props, ['source', 'defaultSource', 'activityIndicatorProps', 'style', 'useQueryParamsInCacheKey', 'renderImage', 'resolveHeaders']);
}
...
const CachedImage = React.createClass({
  ...
  processSource(source) {
    ...
    if (ImageCacheProvider.isCacheable(url)) {
      const options = pick(this.props, ['useQueryParamsInCacheKey', 'cacheGroup']);
